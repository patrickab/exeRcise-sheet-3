...
However, since the string value "4 oder weniger" cannot be converted to a integer datatype, therefore each column-value presenting this value has been converted to "NA". In order to not loose data and keep working with at least inaccurate results, these values can be replaced with an integer of value 4.
